...
@section('container')
    <section>
        ...
        <div class="container-fluid">
            ...
            <a href="/guruexportexcel" class="btn btn-success mb-3"><i class="bi bi-file-earmark-spreadsheet"></i> Export
                Excel</a>
            <a href="/guruexportpdf" class="btn btn-danger mb-3"><i class="bi bi-filetype-pdf"></i> Export
                Pdf</a>
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-dark">
                    <strong class="card-title text-white">Data Guru</strong>
                    <a class="btn btn-sm btn-primary float-right rounded " href="/guru/create"> <i
                                        ...
                                        <td>
                                            @if ($g->foto)
                                                <div style="max-height: 100px;width:100px; overflow:hidden;">
                                                    <img src="{{ asset('storage/' . $g->foto) }}" alt="gambar"
