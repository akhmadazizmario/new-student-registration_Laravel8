    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-dark">
                <strong class="card-title text-white">Created Data Surat masuk</strong>
                <a class="btn btn-sm btn-danger float-right rounded" href="/suratmasuk"> <i class="fa fa-plus-square-o"></i>
                    Kembali </a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <form method="post" action="/suratmasuk" class="mb-5" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="penerima" name="penerima"
                                @error('penerima') is-invalid @enderror required autofocus value="{{ old('penerima') }}">
                            @error('penerima')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <hr>
                        <div class="mt-5">
                            <button type="submit" class="btn btn-primary text-white">Tambah Data Surat Masuk</button>
