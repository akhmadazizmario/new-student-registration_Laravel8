...
@section('container')
    <section>
        ...
        <div class="container-fluid">
            ...
            <a href="/suratmasukexportexcel" class="btn btn-success mb-3"><i class="bi bi-file-earmark-spreadsheet"></i> Export
                Excel</a>
            <a href="/suratmasukexportpdf" class="btn btn-danger mb-3"><i class="bi bi-filetype-pdf"></i> Export
                Pdf</a>
                            ...
                            <tbody>
                                @foreach ($suratmasuk as $s)
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="/suratmasuk/{{ $s->id }}/edit"
                                                    class="btn btn-warning text-decoration-none text-white">
                                                    <i class="bi bi-pencil-square"></i> edit</a>

                                                <form action="/suratmasuk/{{ $s->id }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
