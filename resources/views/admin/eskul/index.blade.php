        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-dark">
                    <strong class="card-title text-white">Data Ekstrakulikuler</strong>
                    <a class="btn btn-sm btn-primary float-right rounded " href="/eskul/create"> <i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($b->foto_eskul)
                                                <div style="max-height: 100px;width:100px; overflow:hidden;">
                                                    <img src="{{ asset('storage/' . $b->foto_eskul) }}" alt="gambar"
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <a href="/eskul/{{ $b->id }}/edit"
                                                    class="btn btn-warning text-decoration-none text-white">
                                                    <i class="bi bi-pencil-square"></i> edit</a>

                                                <form action="/eskul/{{ $b->id }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
