    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-dark">
                <strong class="card-title text-white">Edit Surat Keluar {{ $suratkeluar->pengirim }}</strong>
                <a class="btn btn-sm btn-danger float-right rounded" href="/suratkeluar"> <i class="fa fa-plus-square-o"></i>
                    Kembali </a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <form method="post" action="/suratkeluar/{{ $suratkeluar->id }}" class="mb-5"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tujuan" name="tujuan"
                                @error('tujuan') is-invalid @enderror required autofocus
