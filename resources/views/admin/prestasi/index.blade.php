        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-dark">
                    <strong class="card-title text-white">Data Prestasi</strong>
                    <a class="btn btn-sm btn-primary float-right rounded " href="/prestasi/create"> <i
                                        ...
                                        <td>
                                            @if ($b->foto_prestasi)
                                                <div style="max-height: 100px;width:100px; overflow:hidden;">
                                                    <img src="{{ asset('storage/' . $b->foto_prestasi) }}" alt="gambar"
