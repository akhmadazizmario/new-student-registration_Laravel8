        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-dark">
                    <strong class="card-title text-white">Data Galeri</strong>
                    <a class="btn btn-sm btn-primary float-right rounded " href="/galeri/create"> <i
                            class="bi bi-person-plus"></i>
                        Tambah Data Galeri </a>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($b->foto_galeri)
                                                <div style="max-height: 100px;width:100px; overflow:hidden;">
                                                    <img src="{{ asset('storage/' . $b->foto_galeri) }}" alt="gambar"
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <a href="/galeri/{{ $b->id }}/edit"
                                                    class="btn btn-warning text-decoration-none text-white">
                                                    <i class="bi bi-pencil-square"></i> edit</a>

                                                <form action="/galeri/{{ $b->id }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
